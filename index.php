            ...
            <div class="col-12">
                <nav class="navbar navbar-expand-lg mainmenu">
                    ...
                    <a class="navbar-brand mr-5 text-dark float-left" href="index.html">
                        <img class="" src="<?php echo get_template_directory_uri();?>assets/img/logo.png" srcset="assets/img/logo@2x.png 2x" alt=""/>
                    </a>
                    <!--logo-->
...
<!--hero section start-->
<div id="home">
    <section class="hero js_full_height base-gradient- " style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/hero.jpg'); height:100vh;">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4 mb-md-0 mb-4">
                <img class="footer-logo" src="<?php echo get_template_directory_uri();?>/assets/img/logo.png" srcset="assets/img/logo@2x.png 2x" alt="">
            </div>
            <div class="col-md-4  mb-md-0 mb-4">
